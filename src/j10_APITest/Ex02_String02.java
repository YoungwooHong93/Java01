...
public class Ex02_String02 {
	...
	public static void main(String[] args) {
		...
		System.out.printf("** indexOf => %d, %d, %d \n",name.indexOf("홍"),
				city.indexOf("e"), country.indexOf("o"));
		System.out.println("");
