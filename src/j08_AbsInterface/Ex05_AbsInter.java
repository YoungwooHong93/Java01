...
// ** 추상클래스 : 일반메서드, 추상메서드
// => 추상클래스는 추상 메서드를 포함 할 수 있으므로 구현 의무(오버라이딩)가 없음.  
// => 필요한 것만 선택하여 구현(오버라이딩) 할 수 있다.
...
// => 추상 클래스를 상속 받도록 하여 의무구현 메서드를 줄여줌.
...
public class Ex05_AbsInter {
	...
	public static void main(String[] args) {
		...
		// => QnABoard 는 implements Boardi -> BoardA 와는 무관
		// => 그러나 MyBoard, QnABoard2 는 둘다 가능
		ba.delete();
		ba.detail();
		ba.insert();
		ba.listPrint();
